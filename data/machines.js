// ============================================================
//  MAKİNE ARIZALARI
//  Yapı: Makine → Arıza → Sebepler → Çözüm
// ============================================================
const machineData = {
    ...
    faults: [
      {
        ...
        causes: [
          ...
          },
          {
            ...
            solution: 'Fazlar ya yok ya da ters dir. Priz düz tornavida ile değiştirilip tekrar takılsın. Fazlar geliyorsa ölçüm aleti ile üç faz ölçülüp kontrol edilecek.'
          },
          {
